          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="group relative w-full px-6 py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-black text-sm font-bold overflow-hidden cursor-pointer"
              >
                <motion.div
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.97 }}
                className="group relative w-full px-6 py-4 bg-zinc-950/50 backdrop-blur-sm text-zinc-300 text-sm font-medium overflow-hidden border border-zinc-800 cursor-pointer"
              >
                <motion.div
              ...
              >
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="group relative px-8 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-black text-sm font-bold overflow-hidden cursor-pointer" 
                  >
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-emerald-400 to-green-400"
                      initial={{ x: '-100%' }}
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="group relative px-8 py-3 bg-zinc-950/50 backdrop-blur-sm text-zinc-300 text-sm font-medium overflow-hidden border border-zinc-800 cursor-pointer"
                  >
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-r from-green-500/10 to-emerald-500/10"
                      initial={{ opacity: 0 }}
